            ...
            <div class="bg-white p-4 shadow-sm rounded ">
                <form action="{{ route('topic.create') }}" method="POST">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input name="choice1" name="choice1" type="text" class="form-control">
                    </div>
                    <div class="form-group mb-3">
                        <label for="choice2">回答2</label>
                        <input name="choice2" name="choice2" type="text" class="form-control">
                    </div>
                    <div class="form-group mb-3">
                        <label for="choice3">回答3</label>
                        <input name="choice3" name="choice3" type="text" class="form-control">
                    </div>
                    <div class="form-group mb-3">
                        <label for="choice4">回答4</label>
                        <input name="choice4" name="choice4" type="text" class="form-control">
                    </div>
                    <div class="form-group mb-3">
                        <label for="choice5">回答5</label>
                        <input name="choice5" name="choice5" type="text" class="form-control">
                    </div>
